'''
    Daniel Burris - Individual portion of COMP6710 Group Project
    vault4paper.py

    This python file is about removing hard-coded secrets from all the YAML files underneath the Ansible folder
    and all the hard-coded secrets underneath the Puppet folder
'''
